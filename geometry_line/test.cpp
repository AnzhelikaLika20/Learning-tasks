...
void TestLine(int64_t start_x, int64_t start_y, int64_t end_x, int64_t end_y, int64_t a_x, int64_t a_y, int64_t b_x,
              int64_t b_y, bool contains, bool crosses, int64_t a_line, int64_t b_line, int64_t c_line) {
